...
<head>
    ...
    <title>GeoLog - Smart Digital Logbook System</title>
...
<body>
    ...
    <section class="features" id="features">
        <div class="features-container">
            <h2 class="section-title">Why Choose GeoLog?</h2>
    ...
    <footer class="footer">
        <div class="footer-container">
            <div class="footer-content">
                <div class="footer-logo">
                    <div class="logo">
                        ...
                        <span style="color: white;">GeoLog</span>
                    </div>
                </div>
            ...
            <div class="footer-bottom">
                <p>&copy; 2025 Smart Digital Logbook System (GeoLog). Built with 💖 by Students of BOUESTI.</p>
            </div>
        </div>
    </footer>
